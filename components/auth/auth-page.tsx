...
export function AuthForm() {
  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden flex items-center justify-center p-6">
      ...
      <div
        className={`absolute top-0 left-0 right-0 h-64 transition-all duration-1500 ease-in-out ${
          isLogin
      ...
      />
      <div
        className={`absolute top-0 left-0 right-0 h-48 transition-all duration-1500 ease-in-out ${
          isLogin
      ...
      />
      <div
        className={`absolute top-0 left-0 right-0 h-32 transition-all duration-1500 ease-in-out ${
          isLogin
        ...
        >
          <AnimatePresence mode="wait">
            <motion.div
              ...
              // MODIFIED ANIMATION: Simple cross-fade, no sliding
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
                  ...
                  <form onSubmit={handleSubmit} className="space-y-2">
                    ...
                    {!isLogin && (
                      ...
                      >
                        ...
                        <Input id="name" type="text" value={name} onChange={(e) => setName(e.target.value)} required className="h-10"/>
                      </motion.div>
                    )}
                    ...
                    <div className="space-y-2">
                        ...
                        <Select value={selectedRole} onValueChange={(val: UserRole) => handleRoleChange(val)}>
                    ...
                    {selectedRole === "admin" && (
                        <motion.div
                            ...
                            className="space-y-2 overflow-hidden"
                        >
                            <Label htmlFor="adminSubRole" className="text-sm font-medium">Admin Type</Label>
                            <Select value={selectedAdminSubRole} onValueChange={(val: AdminSubRole) => setSelectedAdminSubRole(val)}>
                                <SelectTrigger className="h-10"><SelectValue placeholder="Select admin type" /></SelectTrigger>
                                <SelectContent>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            <Input id="password" type={showPassword ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} required className="h-10 pr-10"/>
                    ...
                    {!isLogin && (
                      ...
                      >
                          ...
                          <div className="relative">
                              <Input id="confirmPassword" type={showConfirmPassword ? "text" : "password"} value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} required className="h-10 pr-10"/>
                    ...
                    {/* Submit Button */}
                    <Button type="submit" className={`w-full h-10 text-white font-medium transition-all ${ isLogin ? "bg-emerald-600 hover:bg-emerald-700" : "bg-blue-600 hover:bg-blue-700"}`} disabled={isLoading}>
                      {isLoading ? (
                        <>
